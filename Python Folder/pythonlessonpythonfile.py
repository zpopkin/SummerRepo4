...
# R's equivalent of atomic vectors are constructed using the Python
# command np.array
...
# We can also perform operations on defined vectors/arrays
...
#  Now create modified data tables for declared conditions.
...
estate.sort_values(by="Price", ascending=True)
