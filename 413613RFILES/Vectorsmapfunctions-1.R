...
# identify the vector and use the function  "length" to determine the number
# of elements that the vector has.
...
# Naming , describing or listing the content of a vector. Use the code 
# set_names from the purr package.
...
# Recall that lists can contain diferent object types.
...
# Solution: assign the charater string to a variable, and then apply $
# to the variable
