...
# called.
#      - R:  f(x, y = 1)  for R, we use parentheses and commas
#      - Bash:  f x --y=1 for Bash, no commas and no parentheses
...
#    make a directory called practicefolder1 (mkdir practicefolder1)
#    now change directory to practicefolder1  (cd practicefoldr1/)
...
#   to specified files over a period of time and maintains a library
...
#        Github)
# Step 5 git add (Add the files in your new local repository. This stages it for
# the first commit.)
...
# Step 8 Enter:  git remote add <some nickname> <the copied URL>
...
# to Github)
# Step 11 Go to Github and locate your file
