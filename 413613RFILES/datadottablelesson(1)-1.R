...
# Use data.table for large datasets that you read
# in with fread()
...
# To get a specific row, insert a number into the brackets.  We will extract the content of rows 1, 3,
# and 207
...
# We sill select the column variables origin and dest
...
# one call for the data.table method rather than using two or more
# separate functions.
...
# Lets select AA, find the mean of arrival delays(gouping
