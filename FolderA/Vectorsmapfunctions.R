...
V <- c(12, 33, 2, 82, 33)  # All objects are integers

v1 <- c(.002, 3.6, 7.32, 4.5, 6.0) # All objects are doubles

V2 <- c(FALSE, TRUE, TRUE, FALSE)  # All objects are logical entries

V3 <- C("JANE", "BILL", "JUAN", "EILEEN", "ANN") # All objects are
# character strings

# Examples of Lists (objects can be of different types)

L <- list(6, 3.8, "every", TRUE)

L1 <- list(TRUE, 12, .0125, "cat", list(2:5)) # note that a list can
